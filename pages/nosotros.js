...
function Nosotros() {
  ...
  return (
    ...
    {lang==="esp" ? <div id="about-text">
      ...
      <blockquote><p className="quote"><strong>Si en el final está la representación</strong>, durante el proceso nos encontramos con la búsqueda, la duda, los matices, la idealización, el amor y el odio hacia lo que nos rodea.</p>
        <p className="quote"><strong>Si en el final tenemos la imagen</strong>, hemos recorrido la sensación, la idea, la palabra, el sonido y todas aquellas cosas que nos permiten interpretar y expresar lo que sucede.</p>
        <p className="quote">Por esta faceta integral vemos nuestro trabajo como una <strong>forma de vivir</strong> y lo proyectamos como una <strong>apología a la realidad y la imaginación</strong>.</p>
    ...
    <div id="about-text">
      ...
      <blockquote><p className="quote"><strong>If in the end is the representation</strong>, in the process we meet the search, the doubt, the nuances, the idealization, the love and hate to what surround us.</p>
        <p className="quote"><strong>If in the end is the image</strong>, we have come through the sensation, the idea, the word, the sound and all those things that allow us to interpret and express what happens.</p>
        <p className="quote">For this integral facet we see our work as a <strong>way of life</strong> and we project it as a <strong>celebration to reality and imagination</strong>.</p>
        <cite>_ Claroscuro Producciones</cite>
      </blockquote>
    </div>}
  </>
